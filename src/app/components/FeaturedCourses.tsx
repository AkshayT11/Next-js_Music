...
const FeaturedCourses = () => {
   const feCourses = courseData.courses.filter((course:Course)=> course.isFeatured)
  ...
  return (
    <div className="py-12 bg-gray-900">
      ...
      justify-center ">
        {feCourses.map((course:Course)=>(
          <div key={course.id} className="flex justify-center">
            <BackgroundGradient className="flex flex-col
            rounded-[22px] overflow-hidden bg-white dark:bg-zinc-900 
            h-full max-w-sm" >

              <div className="flex p-4 sm:p-6 items-center text-center flex-col flex-grow ">
                <p className="text-lg sm:text-2xl font-bold text-black 
               mt-4 mb-2 dark:text-neutral-200 " >{course.title} </p>
      ...
      <div className="mt-20 text-center">
        <Link href={"/courses"}
        className="px-4 py-2 border border-neutral-600 text-neutral-700 
